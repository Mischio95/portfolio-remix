...
export function registerAnimations() {
  ...
  gsap.utils.toArray(".animated-element").forEach((element: any) => {
    gsap.fromTo(
      ...
      {
        opacity: 3, // Arriva a opacità 1
        y: 0, // Torna alla posizione originale
        duration: 1, // Durata dell'animazione
        scrollTrigger: {
          trigger: element, // L'elemento che attiva il trigger
          start: "top 80%", // Inizia quando l'elemento è al 80% della viewport
          end: "bottom 20%", // Termina quando l'elemento esce dal 20% della viewport
